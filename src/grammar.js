...
var grammar = {
    Lexer: mxLexer,
    ParserRules: [
    {"name": "Main$ebnf$1", "symbols": ["_expr_seq"], "postprocess": id},
    {"name": "Main$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "Main", "symbols": ["_", "Main$ebnf$1", "_"], "postprocess": d => d[1]},
    ...
    {"name": "rcmenu_sep$ebnf$1$subexpression$1", "symbols": ["_", "parameter"]},
    ...
    {"name": "ATTRIBUTES_DEF$ebnf$1$subexpression$1", "symbols": ["_", "parameter"]},
    ...
    {"name": "ATTRIBUTES_DEF", "symbols": ["ATTRIBUTES_DEF$subexpression$1", "VAR_NAME", "ATTRIBUTES_DEF$ebnf$1", "_", "LPAREN", "attributes_clauses", "RPAREN"], "postprocess":  d => ({
    ...
    {"name": "PARAM_DEF$ebnf$1$subexpression$1", "symbols": ["_", "parameter"]},
    ...
    {"name": "PARAM_DEF$ebnf$2", "symbols": ["param_clauses"], "postprocess": id},
    {"name": "PARAM_DEF$ebnf$2", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "PARAM_DEF", "symbols": ["PARAM_DEF$subexpression$1", "VAR_NAME", "PARAM_DEF$ebnf$1", "_", "LPAREN", "PARAM_DEF$ebnf$2", "RPAREN"], "postprocess":  d => ({
    ...
    {"name": "TOOL_DEF", "symbols": [(mxLexer.has("kw_tool") ? {type: "kw_tool"} : kw_tool), "__", "VAR_NAME", "TOOL_DEF$ebnf$1", "_", "LPAREN", "tool_clauses", "RPAREN"], "postprocess":  d => ({
            type:   'EntityTool',
            id:     d[2],
            params: flatten(d[3]),
            body:   d[6],
    ...
    {"name": "item_group", "symbols": [(mxLexer.has("kw_group") ? {type: "kw_group"} : kw_group), "_", "STRING", "_", "LPAREN", "group_clauses", "RPAREN"], "postprocess":  d => ({
    ...
    {"name": "CHANGE_HANDLER$ebnf$2$subexpression$1", "symbols": ["parameter", "_"]},
    ...
    {"name": "CHANGE_HANDLER", "symbols": [(mxLexer.has("kw_when") ? {type: "kw_when"} : kw_when), "__", "CHANGE_HANDLER$ebnf$1", "__", "operand", "__", "VAR_NAME", "__", "CHANGE_HANDLER$ebnf$2", "CHANGE_HANDLER$ebnf$3", "_", (mxLexer.has("kw_do") ? {type: "kw_do"} : kw_do), "_", "expr"], "postprocess":  d=> ({
            type:  'WhenStatement',
    ...
    {"name": "context", "symbols": ["context$ebnf$1", "context$subexpression$1", "_", "unary_operand"], "postprocess":  d => ({
    ...
    {"name": "context$ebnf$2$subexpression$1", "symbols": [(mxLexer.has("kw_set") ? {type: "kw_set"} : kw_set), "__"]},
    ...
    {"name": "context", "symbols": ["context$ebnf$2", (mxLexer.has("kw_in") ? {type: "kw_in"} : kw_in), "_", "unary_operand"], "postprocess":  d => ({
            type:    'ContextExpression',
    ...
    {"name": "context$ebnf$3$subexpression$1$subexpression$1", "symbols": [(mxLexer.has("kw_set") ? {type: "kw_set"} : kw_set)]},
    {"name": "context$ebnf$3$subexpression$1$subexpression$1", "symbols": [(mxLexer.has("kw_in") ? {type: "kw_in"} : kw_in)]},
    {"name": "context$ebnf$3$subexpression$1", "symbols": ["context$ebnf$3$subexpression$1$subexpression$1", "__"]},
    ...
    {"name": "context", "symbols": ["context$ebnf$3", (mxLexer.has("kw_coordsys") ? {type: "kw_coordsys"} : kw_coordsys), "_", "context$subexpression$2"], "postprocess":  d => ({
            type: 'ContextExpression',
            prefix : (d[0] != null ? d[0][0][0] : null),
            context: d[1],
            args:    d[3][0],
    ...
    {"name": "context$ebnf$4$subexpression$1", "symbols": [(mxLexer.has("kw_set") ? {type: "kw_set"} : kw_set), "__"]},
    ...
    {"name": "context", "symbols": ["context$ebnf$4", (mxLexer.has("kw_about") ? {type: "kw_about"} : kw_about), "_", "context$subexpression$3"], "postprocess":  d => ({
            type: 'ContextExpression',
            prefix : (d[0] != null ? d[0][0] : null),
            context: d[1],
            args:    d[3][0],
    ...
    {"name": "context$ebnf$5$subexpression$1$subexpression$1", "symbols": [(mxLexer.has("kw_with") ? {type: "kw_with"} : kw_with)]},
    ...
    {"name": "context", "symbols": ["context$ebnf$5", (mxLexer.has("kw_context") ? {type: "kw_context"} : kw_context), "_", "context$subexpression$4"], "postprocess":  d => ({
            type: 'ContextExpression',
            prefix :(d[0] != null ? d[0][0][0] : null),
            context: d[1],
            args:    d[3][0],
    ...
    {"name": "context$ebnf$6$subexpression$1", "symbols": [(mxLexer.has("kw_with") ? {type: "kw_with"} : kw_with), "__"]},
    {"name": "context$ebnf$6", "symbols": ["context$ebnf$6$subexpression$1"], "postprocess": id},
    ...
    {"name": "context", "symbols": ["context$ebnf$6", (mxLexer.has("kw_defaultAction") ? {type: "kw_defaultAction"} : kw_defaultAction), "_", "context$subexpression$5"], "postprocess":  d => ({
            type: 'ContextExpression',
            prefix :  (d[0] != null ? d[0][0] : null),
            context: d[1],
            args:    d[3][0],
    ...
    {"name": "context$ebnf$7$subexpression$1$subexpression$1", "symbols": [(mxLexer.has("kw_set") ? {type: "kw_set"} : kw_set)]},
    {"name": "context$ebnf$7$subexpression$1$subexpression$1", "symbols": [(mxLexer.has("kw_with") ? {type: "kw_with"} : kw_with)]},
    {"name": "context$ebnf$7$subexpression$1", "symbols": ["context$ebnf$7$subexpression$1$subexpression$1", "__"]},
    ...
    {"name": "context$ebnf$8$subexpression$1", "symbols": ["undo_label", "_"]},
    {"name": "context$ebnf$8", "symbols": ["context$ebnf$8$subexpression$1"], "postprocess": id},
    ...
    {"name": "context", "symbols": ["context$ebnf$7", (mxLexer.has("kw_undo") ? {type: "kw_undo"} : kw_undo), "_", "context$ebnf$8", "context$subexpression$6"], "postprocess":  d => ({
            type:    'ContextExpression',
            prefix : (d[0] != null ? d[0][0][0] : null),
            context: d[1],
    ...
    {"name": "case_src", "symbols": ["expr", "_"], "postprocess": id},
    ...
    {"name": "FOR_LOOP", "symbols": ["FOR_LOOP$subexpression$1", "for_index", "_S", "for_iterator", "_S", "expr", "FOR_LOOP$ebnf$1", "_", "FOR_LOOP$subexpression$2", "_", "expr"], "postprocess":  d => ({
            type:     'ForStatement',
            index:     d[1],
            iteration: d[3],
            value:     d[5],
    ...
    {"name": "DO_LOOP", "symbols": [(mxLexer.has("kw_do") ? {type: "kw_do"} : kw_do), "_", "expr", "_", (mxLexer.has("kw_while") ? {type: "kw_while"} : kw_while), "_", "expr"], "postprocess":  d => ({
    ...
    {"name": "TRY_EXPR", "symbols": [(mxLexer.has("kw_try") ? {type: "kw_try"} : kw_try), "_", "expr", "_", (mxLexer.has("kw_catch") ? {type: "kw_catch"} : kw_catch), "_", "expr"], "postprocess":  d => ({
            type:      'TryStatement',
            body:      d[2],
            finalizer: d[6],
            range:     getLoc(d[0], d[6])
    ...
    {"name": "param_name", "symbols": ["param_name$subexpression$1", {"literal":":"}], "postprocess":  d => ({
            type:'Parameter',
            value: d[0][0],
            range: getLoc(d[0], d[1])
        }) },
    ...
    {"name": "bitarray", "symbols": [(mxLexer.has("bitarraydef") ? {type: "bitarraydef"} : bitarraydef), "RBRACE"], "postprocess":  d => ({
            type:     'ObjectBitArray',
            elements: [],
            range:    getLoc(d[0], d[1])
        }) },
    {"name": "bitarray$subexpression$1", "symbols": [(mxLexer.has("bitarraydef") ? {type: "bitarraydef"} : bitarraydef), "_"]},
    {"name": "bitarray", "symbols": ["bitarray$subexpression$1", "bitarray_expr", "RBRACE"], "postprocess":  d => ({
            type:     'ObjectBitArray',
            elements: d[1],
    ...
    {"name": "LPAREN", "symbols": [(mxLexer.has("lparen") ? {type: "lparen"} : lparen), "_"], "postprocess": id},
    {"name": "RPAREN", "symbols": ["_", (mxLexer.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": d => d[1]},
    {"name": "LBRACKET", "symbols": [(mxLexer.has("lbracket") ? {type: "lbracket"} : lbracket), "_"], "postprocess": id},
