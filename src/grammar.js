...
var grammar = {
    ...
    {"name": "Main$ebnf$1", "symbols": ["Main$ebnf$1", "anyws"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    ...
    {"name": "Main$ebnf$3", "symbols": ["Main$ebnf$3", "anyws"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    ...
    {"name": "rollout_item$ebnf$1$subexpression$1", "symbols": ["rollout_item$ebnf$1$subexpression$1$ebnf$1", "OPERAND"]},
    ...
    {"name": "MACROSCRIPT_DEF$ebnf$1$subexpression$1", "symbols": ["MACROSCRIPT_DEF$ebnf$1$subexpression$1$ebnf$1", "parameter"]},
    ...
    {"name": "struct_members$ebnf$1$subexpression$1", "symbols": ["EOL_COMMA", "struct_member"]},
    ...
    {"name": "CHANGE_HANDLER$ebnf$1", "symbols": ["__"], "postprocess": id},
    ...
    {"name": "CHANGE_HANDLER$ebnf$3", "symbols": ["OPERAND"], "postprocess": id},
    ...
    {"name": "CHANGE_HANDLER", "symbols": [(mxLexer.has("kw_when") ? {type: "kw_when"} : kw_when), "__", "CHANGE_HANDLER$subexpression$1", "CHANGE_HANDLER$ebnf$1", "OPERAND", "__", "VAR_NAME", "__", "CHANGE_HANDLER$ebnf$2", "CHANGE_HANDLER$ebnf$3", "CHANGE_HANDLER$ebnf$4", (mxLexer.has("kw_do") ? {type: "kw_do"} : kw_do), "CHANGE_HANDLER$ebnf$5", "expr"], "postprocess":  d=> ({
            type:  'WhenStatement',
            args:  merge(...d.slice(2,9)),
            body:  d[13],
            range: getLoc(d[0], d[13])
        })},
    {"name": "CHANGE_HANDLER$ebnf$6", "symbols": ["__"], "postprocess": id},
    {"name": "CHANGE_HANDLER$ebnf$6", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "CHANGE_HANDLER$ebnf$7", "symbols": ["__"], "postprocess": id},
    {"name": "CHANGE_HANDLER$ebnf$7", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "CHANGE_HANDLER$ebnf$8", "symbols": []},
    {"name": "CHANGE_HANDLER$ebnf$8$subexpression$1$ebnf$1", "symbols": ["__"], "postprocess": id},
    {"name": "CHANGE_HANDLER$ebnf$8$subexpression$1$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "CHANGE_HANDLER$ebnf$8$subexpression$1", "symbols": ["parameter", "CHANGE_HANDLER$ebnf$8$subexpression$1$ebnf$1"]},
    {"name": "CHANGE_HANDLER$ebnf$8", "symbols": ["CHANGE_HANDLER$ebnf$8", "CHANGE_HANDLER$ebnf$8$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "CHANGE_HANDLER$ebnf$9", "symbols": ["OPERAND"], "postprocess": id},
    {"name": "CHANGE_HANDLER$ebnf$9", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "CHANGE_HANDLER$ebnf$10", "symbols": ["__"], "postprocess": id},
    {"name": "CHANGE_HANDLER$ebnf$10", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "CHANGE_HANDLER$ebnf$11", "symbols": ["__"], "postprocess": id},
    {"name": "CHANGE_HANDLER$ebnf$11", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "CHANGE_HANDLER", "symbols": [(mxLexer.has("kw_when") ? {type: "kw_when"} : kw_when), "CHANGE_HANDLER$ebnf$6", "OPERAND", "CHANGE_HANDLER$ebnf$7", "VAR_NAME", "__", "CHANGE_HANDLER$ebnf$8", "CHANGE_HANDLER$ebnf$9", "CHANGE_HANDLER$ebnf$10", (mxLexer.has("kw_do") ? {type: "kw_do"} : kw_do), "CHANGE_HANDLER$ebnf$11", "expr"], "postprocess":  d=> ({
            type:  'WhenStatement',
    ...
    {"name": "FUNCTION_DEF$ebnf$1$subexpression$1", "symbols": ["FUNCTION_DEF$ebnf$1$subexpression$1$ebnf$1", "fn_args"]},
    ...
    {"name": "FUNCTION_DEF$ebnf$1$subexpression$2", "symbols": ["FUNCTION_DEF$ebnf$1$subexpression$2$ebnf$1", "fn_args"]},
    ...
    {"name": "FUNCTION_DEF$ebnf$3$subexpression$1", "symbols": ["FUNCTION_DEF$ebnf$3$subexpression$1$ebnf$1", "fn_args"]},
    ...
    {"name": "FUNCTION_DEF$ebnf$3$subexpression$2", "symbols": ["FUNCTION_DEF$ebnf$3$subexpression$2$ebnf$1", "fn_args"]},
    ...
    {"name": "fn_args", "symbols": ["VAR_NAME"], "postprocess": id},
    {"name": "fn_args", "symbols": ["by_Ref"], "postprocess": id},
    ...
    {"name": "CONTEXT_EXPR$ebnf$1$subexpression$1", "symbols": ["COMMA", "ctx_predicate"]},
    ...
    {"name": "CONTEXT_EXPR", "symbols": ["ctx_predicate", "CONTEXT_EXPR$ebnf$1", "CONTEXT_EXPR$ebnf$2", "expr"], "postprocess":  d => ({
            type:    'ContextStatement',
            context: merge(d[0], flatten(d[1])),
            body:    d[3],
            range:   getLoc(d[0], d[3])
        })},
    {"name": "CONTEXT_EXPR", "symbols": ["ctx_set"], "postprocess": id},
    {"name": "ctx_set$ebnf$1", "symbols": ["__"], "postprocess": id},
    {"name": "ctx_set$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "ctx_set$subexpression$1", "symbols": [(mxLexer.has("kw_animate") ? {type: "kw_animate"} : kw_animate)]},
    {"name": "ctx_set$subexpression$1", "symbols": [(mxLexer.has("kw_time") ? {type: "kw_time"} : kw_time)]},
    {"name": "ctx_set$subexpression$1", "symbols": [(mxLexer.has("kw_in") ? {type: "kw_in"} : kw_in)]},
    {"name": "ctx_set$subexpression$1", "symbols": [(mxLexer.has("kw_level") ? {type: "kw_level"} : kw_level)]},
    {"name": "ctx_set$ebnf$2", "symbols": ["__"], "postprocess": id},
    {"name": "ctx_set$ebnf$2", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "ctx_set", "symbols": [(mxLexer.has("kw_set") ? {type: "kw_set"} : kw_set), "ctx_set$ebnf$1", "ctx_set$subexpression$1", "ctx_set$ebnf$2", "SIMPLE_EXPR"], "postprocess":  d => ({
    ...
    {"name": "ctx_set$ebnf$3", "symbols": ["__"], "postprocess": id},
    {"name": "ctx_set$ebnf$3", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "ctx_set$ebnf$4", "symbols": ["__"], "postprocess": id},
    {"name": "ctx_set$ebnf$4", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "ctx_set$subexpression$2", "symbols": [(mxLexer.has("kw_local") ? {type: "kw_local"} : kw_local)]},
    {"name": "ctx_set$subexpression$2", "symbols": ["OPERAND"]},
    {"name": "ctx_set", "symbols": [(mxLexer.has("kw_set") ? {type: "kw_set"} : kw_set), "ctx_set$ebnf$3", (mxLexer.has("kw_coordsys") ? {type: "kw_coordsys"} : kw_coordsys), "ctx_set$ebnf$4", "ctx_set$subexpression$2"], "postprocess":  d => ({
            type:    'ContextExpression',
            prefix : d[0],
            context: d[2],
            args:    d[4][0],
    ...
    {"name": "ctx_set$ebnf$5", "symbols": ["__"], "postprocess": id},
    {"name": "ctx_set$ebnf$5", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "ctx_set$ebnf$6", "symbols": ["__"], "postprocess": id},
    {"name": "ctx_set$ebnf$6", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "ctx_set$subexpression$3", "symbols": [(mxLexer.has("kw_coordsys") ? {type: "kw_coordsys"} : kw_coordsys)]},
    {"name": "ctx_set$subexpression$3", "symbols": ["OPERAND"]},
    {"name": "ctx_set", "symbols": [(mxLexer.has("kw_set") ? {type: "kw_set"} : kw_set), "ctx_set$ebnf$5", (mxLexer.has("kw_about") ? {type: "kw_about"} : kw_about), "ctx_set$ebnf$6", "ctx_set$subexpression$3"], "postprocess":  d => ({
            type:    'ContextExpression',
            prefix : d[0],
            context: d[2],
            args:    d[4][0],
    ...
    {"name": "ctx_set$ebnf$7", "symbols": ["__"], "postprocess": id},
    {"name": "ctx_set$ebnf$7", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "ctx_set$ebnf$8", "symbols": ["__"], "postprocess": id},
    {"name": "ctx_set$ebnf$8", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "ctx_set$ebnf$9$subexpression$1", "symbols": ["STRING"]},
    {"name": "ctx_set$ebnf$9$subexpression$1", "symbols": ["VAR_NAME"]},
    {"name": "ctx_set$ebnf$9$subexpression$1", "symbols": ["parameter"]},
    {"name": "ctx_set$ebnf$9", "symbols": ["ctx_set$ebnf$9$subexpression$1"], "postprocess": id},
    {"name": "ctx_set$ebnf$9", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "ctx_set$ebnf$10", "symbols": ["__"], "postprocess": id},
    {"name": "ctx_set$ebnf$10", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "ctx_set", "symbols": [(mxLexer.has("kw_set") ? {type: "kw_set"} : kw_set), "ctx_set$ebnf$7", (mxLexer.has("kw_undo") ? {type: "kw_undo"} : kw_undo), "ctx_set$ebnf$8", "ctx_set$ebnf$9", "ctx_set$ebnf$10", "SIMPLE_EXPR"], "postprocess":  d => ({
            type:    'ContextExpression',
            prefix : d[0],
            context: d[2],
    ...
    {"name": "ctx_predicate$subexpression$1", "symbols": [(mxLexer.has("kw_level") ? {type: "kw_level"} : kw_level)]},
    ...
    {"name": "ctx_predicate$ebnf$3$subexpression$1", "symbols": [(mxLexer.has("kw_in") ? {type: "kw_in"} : kw_in), "__"]},
    {"name": "ctx_predicate$ebnf$3", "symbols": ["ctx_predicate$ebnf$3$subexpression$1"], "postprocess": id},
    {"name": "ctx_predicate$ebnf$3", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "ctx_predicate$ebnf$4", "symbols": ["__"], "postprocess": id},
    {"name": "ctx_predicate$ebnf$4", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "ctx_predicate$subexpression$2", "symbols": [(mxLexer.has("kw_local") ? {type: "kw_local"} : kw_local)]},
    {"name": "ctx_predicate$subexpression$2", "symbols": ["OPERAND"]},
    {"name": "ctx_predicate", "symbols": ["ctx_predicate$ebnf$3", (mxLexer.has("kw_coordsys") ? {type: "kw_coordsys"} : kw_coordsys), "ctx_predicate$ebnf$4", "ctx_predicate$subexpression$2"], "postprocess":  d => ({
            type: 'ContextExpression',
    ...
    {"name": "ctx_predicate$ebnf$5", "symbols": ["__"], "postprocess": id},
    {"name": "ctx_predicate$ebnf$5", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "ctx_predicate$subexpression$3", "symbols": [(mxLexer.has("kw_coordsys") ? {type: "kw_coordsys"} : kw_coordsys)]},
    {"name": "ctx_predicate$subexpression$3", "symbols": ["OPERAND"]},
    {"name": "ctx_predicate", "symbols": [(mxLexer.has("kw_about") ? {type: "kw_about"} : kw_about), "ctx_predicate$ebnf$5", "ctx_predicate$subexpression$3"], "postprocess":  d => ({
            type: 'ContextExpression',
            prefix : null,
            context: d[0],
            args:    d[2][0],
    ...
    {"name": "ctx_predicate$ebnf$6$subexpression$1", "symbols": [(mxLexer.has("kw_with") ? {type: "kw_with"} : kw_with), "__"]},
    {"name": "ctx_predicate$ebnf$6", "symbols": ["ctx_predicate$ebnf$6$subexpression$1"], "postprocess": id},
    {"name": "ctx_predicate$ebnf$6", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "ctx_predicate$subexpression$4", "symbols": [(mxLexer.has("kw_context") ? {type: "kw_context"} : kw_context)]},
    {"name": "ctx_predicate$subexpression$4", "symbols": [(mxLexer.has("kw_animate") ? {type: "kw_animate"} : kw_animate)]},
    {"name": "ctx_predicate$ebnf$7", "symbols": ["__"], "postprocess": id},
    {"name": "ctx_predicate$ebnf$7", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "ctx_predicate", "symbols": ["ctx_predicate$ebnf$6", "ctx_predicate$subexpression$4", "ctx_predicate$ebnf$7", "SIMPLE_EXPR"], "postprocess":  d => ({
            type: 'ContextExpression',
            prefix :(d[0] != null ? d[0][0] : null),
            context: d[1],
            args:    d[3][0],
    ...
    {"name": "ctx_predicate$ebnf$8$subexpression$1", "symbols": [(mxLexer.has("kw_with") ? {type: "kw_with"} : kw_with), "__"]},
    {"name": "ctx_predicate$ebnf$8", "symbols": ["ctx_predicate$ebnf$8$subexpression$1"], "postprocess": id},
    {"name": "ctx_predicate$ebnf$8", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "ctx_predicate$ebnf$9", "symbols": ["__"], "postprocess": id},
    {"name": "ctx_predicate$ebnf$9", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "ctx_predicate", "symbols": ["ctx_predicate$ebnf$8", (mxLexer.has("kw_defaultAction") ? {type: "kw_defaultAction"} : kw_defaultAction), "ctx_predicate$ebnf$9", "NAME_VALUE"], "postprocess":  d => ({
            type: 'ContextExpression',
            prefix :  (d[0] != null ? d[0][0] : null),
            context: d[1],
            args:    d[3][0],
    ...
    {"name": "ctx_predicate$ebnf$10$subexpression$1", "symbols": [(mxLexer.has("kw_with") ? {type: "kw_with"} : kw_with), "__"]},
    {"name": "ctx_predicate$ebnf$10", "symbols": ["ctx_predicate$ebnf$10$subexpression$1"], "postprocess": id},
    {"name": "ctx_predicate$ebnf$10", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "ctx_predicate$ebnf$11", "symbols": ["__"], "postprocess": id},
    {"name": "ctx_predicate$ebnf$11", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "ctx_predicate$ebnf$12$subexpression$1$ebnf$1", "symbols": ["__"], "postprocess": id},
    {"name": "ctx_predicate$ebnf$12$subexpression$1$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "ctx_predicate$ebnf$12$subexpression$1", "symbols": ["undo_label", "ctx_predicate$ebnf$12$subexpression$1$ebnf$1"]},
    {"name": "ctx_predicate$ebnf$12", "symbols": ["ctx_predicate$ebnf$12$subexpression$1"], "postprocess": id},
    {"name": "ctx_predicate$ebnf$12", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "ctx_predicate", "symbols": ["ctx_predicate$ebnf$10", (mxLexer.has("kw_undo") ? {type: "kw_undo"} : kw_undo), "ctx_predicate$ebnf$11", "ctx_predicate$ebnf$12", "SIMPLE_EXPR"], "postprocess":  d => ({
            type:    'ContextExpression',
            prefix : (d[0] != null ? d[0][0] : null),
            context: d[1],
    ...
    {"name": "sum", "symbols": ["sum", "sum$ebnf$1", "sum$subexpression$1", "sum$ebnf$2", "prod"], "postprocess":  d => ({
            type:     'MathExpression',
            operator: d[2][0],
            left:     d[0],
            right:    d[4],
    ...
    {"name": "exp", "symbols": ["exp", "exp$ebnf$1", {"literal":"^"}, "exp$ebnf$2", "as"], "postprocess":  d => ({
            type:     'MathExpression',
            operator: d[2],
            left:     d[0],
            right:    d[4],
    ...
    {"name": "as", "symbols": ["unary", "as$ebnf$1", (mxLexer.has("kw_as") ? {type: "kw_as"} : kw_as), "__", "VAR_NAME"], "postprocess":  d => ({
            type:     'MathExpression',
            operator: d[2],
            left:     d[0],
            right:    d[4],
    ...
    {"name": "as", "symbols": ["unary"], "postprocess": id},
    {"name": "unary$ebnf$1", "symbols": ["__"], "postprocess": id},
    {"name": "unary$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "unary", "symbols": [{"literal":"-"}, "unary$ebnf$1", "unary"], "postprocess":  d => ({
    ...
    {"name": "call_caller", "symbols": ["index"], "postprocess": id},
    {"name": "call_caller", "symbols": ["expr_seq"], "postprocess": id},
    {"name": "UN_OP", "symbols": [{"literal":"-"}, "OPERAND"], "postprocess":  d => ({
            type: 'UnaryExpression',
            operator: d[0],
            right:    d[1],
            range: getLoc(d[0], d[1])
        }) },
    {"name": "UN_OP", "symbols": ["OPERAND"], "postprocess": id},
    {"name": "parameter$ebnf$1", "symbols": ["__"], "postprocess": id},
    {"name": "parameter$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "parameter", "symbols": ["param_name", "parameter$ebnf$1", "UN_OP"], "postprocess":  d => ({
    ...
    {"name": "property$subexpression$1$ebnf$2", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "property$subexpression$1", "symbols": ["property$subexpression$1$ebnf$1", (mxLexer.has("dot") ? {type: "dot"} : dot), "property$subexpression$1$ebnf$2"]},
    {"name": "property$subexpression$2", "symbols": ["VAR_NAME"]},
    {"name": "property$subexpression$2", "symbols": ["VOID"]},
    {"name": "property$subexpression$2", "symbols": ["kw_override"]},
    ...
    {"name": "index", "symbols": ["OPERAND", "index$ebnf$1", "LBRACKET", "expr", "RBRACKET"], "postprocess":  d => ({
            type:    'AccessorIndex',
            operand: d[0],
            index:   d[3],
    ...
    {"name": "factor", "symbols": ["by_Ref"], "postprocess": id},
    {"name": "factor", "symbols": ["RESOURCE"], "postprocess": id},
    ...
    {"name": "array_expr$ebnf$1$subexpression$1", "symbols": ["EOL_COMMA", "expr"]},
    ...
    {"name": "bitarray_expr$ebnf$1$subexpression$1", "symbols": ["EOL_COMMA", "bitarray_item"]},
    ...
    {"name": "COMMA$ebnf$2", "symbols": ["COMMA$ebnf$2", "anyws"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "COMMA", "symbols": ["COMMA$ebnf$1", (mxLexer.has("comma") ? {type: "comma"} : comma), "COMMA$ebnf$2"], "postprocess": d => null},
    {"name": "EOL_COMMA$ebnf$1", "symbols": ["__"], "postprocess": id},
    {"name": "EOL_COMMA$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "EOL_COMMA$ebnf$2", "symbols": ["__"], "postprocess": id},
    {"name": "EOL_COMMA$ebnf$2", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "EOL_COMMA", "symbols": ["EOL_COMMA$ebnf$1", (mxLexer.has("comma") ? {type: "comma"} : comma), "EOL_COMMA$ebnf$2"], "postprocess": d => null},
    {"name": "LPAREN$ebnf$1", "symbols": []},
    {"name": "LPAREN$ebnf$1", "symbols": ["LPAREN$ebnf$1", "anyws"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "LPAREN", "symbols": [(mxLexer.has("lparen") ? {type: "lparen"} : lparen), "LPAREN$ebnf$1"], "postprocess": id},
    {"name": "RPAREN$ebnf$1", "symbols": []},
    {"name": "RPAREN$ebnf$1", "symbols": ["RPAREN$ebnf$1", "anyws"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "RPAREN", "symbols": ["RPAREN$ebnf$1", (mxLexer.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": d => d[1]},
    {"name": "LBRACKET$ebnf$1", "symbols": []},
    {"name": "LBRACKET$ebnf$1", "symbols": ["LBRACKET$ebnf$1", "wsl"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "LBRACKET", "symbols": [(mxLexer.has("lbracket") ? {type: "lbracket"} : lbracket), "LBRACKET$ebnf$1"], "postprocess": id},
    {"name": "RBRACKET$ebnf$1", "symbols": []},
    {"name": "RBRACKET$ebnf$1", "symbols": ["RBRACKET$ebnf$1", "wsl"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "RBRACKET", "symbols": ["RBRACKET$ebnf$1", (mxLexer.has("rbracket") ? {type: "rbracket"} : rbracket)], "postprocess": d => d[1]},
    {"name": "LBRACE$ebnf$1", "symbols": []},
    {"name": "LBRACE$ebnf$1", "symbols": ["LBRACE$ebnf$1", "wsl"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "LBRACE", "symbols": [(mxLexer.has("lbrace") ? {type: "lbrace"} : lbrace), "LBRACE$ebnf$1"], "postprocess": id},
    {"name": "RBRACE$ebnf$1", "symbols": []},
    {"name": "RBRACE$ebnf$1", "symbols": ["RBRACE$ebnf$1", "wsl"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "RBRACE", "symbols": ["RBRACE$ebnf$1", (mxLexer.has("rbrace") ? {type: "rbrace"} : rbrace)], "postprocess": d => d[1]},
    {"name": "by_Ref$subexpression$1", "symbols": ["VAR_NAME"]},
    ...
    {"name": "EOL$ebnf$1", "symbols": ["EOL$ebnf$1", "anyws"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    ...
    {"name": "__$ebnf$1", "symbols": ["__$ebnf$1", "anyws"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    ...
    {"name": "anyws", "symbols": [(mxLexer.has("ws") ? {type: "ws"} : ws)]},
    {"name": "anyws", "symbols": [(mxLexer.has("newline") ? {type: "newline"} : newline)]},
    {"name": "anyws", "symbols": [(mxLexer.has("comment_BLK") ? {type: "comment_BLK"} : comment_BLK)]},
    {"name": "anyws", "symbols": [(mxLexer.has("comment_SL") ? {type: "comment_SL"} : comment_SL)]}
]
  , ParserStart: "Main"
}
