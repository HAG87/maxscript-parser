...
var grammar = {
    ...
    {"name": "call_params", "symbols": ["call_params", "_S", "call_args"], "postprocess": d => [].concat(d[0], d[2])},
    {"name": "call_params", "symbols": ["call_args"]},
    {"name": "call_caller", "symbols": ["var_name"], "postprocess": id},
    {"name": "call_caller", "symbols": ["property"], "postprocess": id},
    {"name": "call_args", "symbols": ["operand"], "postprocess": id},
    {"name": "call_args", "symbols": ["parameter"], "postprocess": id},
    ...
    {"name": "factor", "symbols": ["factors"], "postprocess": id},
    {"name": "factor", "symbols": ["u_expr"], "postprocess": id},
    {"name": "factor", "symbols": ["not_expr"], "postprocess": id},
    {"name": "u_expr", "symbols": [{"literal":"-"}, "u_factor"], "postprocess":  d => ({
            type: 'UnaryExpression',
            operator: d[0],
            right:    d[1]
        }) },
    {"name": "u_factor", "symbols": ["number"], "postprocess": id},
    {"name": "u_factor", "symbols": ["time"], "postprocess": id},
    {"name": "u_factor", "symbols": ["var_name"], "postprocess": id},
    {"name": "u_factor", "symbols": ["array"], "postprocess": id},
    {"name": "u_factor", "symbols": ["bitarray"], "postprocess": id},
    {"name": "u_factor", "symbols": ["point4"], "postprocess": id},
    {"name": "u_factor", "symbols": ["point3"], "postprocess": id},
    {"name": "u_factor", "symbols": ["point2"], "postprocess": id},
    {"name": "u_factor", "symbols": ["expr_seq"], "postprocess": id},
    {"name": "u_factor", "symbols": ["fn_call"], "postprocess": id},
    {"name": "not_expr", "symbols": [(mxLexer.has("kw_not") ? {type: "kw_not"} : kw_not), "_", "neg_factor"], "postprocess":  d => ({
            type :    'LogicalExpression',
            operator: d[0],
            right:    d[2]
        }) },
    ...
    {"name": "factors", "symbols": ["string"], "postprocess": id},
    {"name": "factors", "symbols": ["number"], "postprocess": id},
    {"name": "factors", "symbols": ["path_name"], "postprocess": id},
    {"name": "factors", "symbols": ["name_value"], "postprocess": id},
    {"name": "factors", "symbols": ["bool"], "postprocess": id},
    {"name": "factors", "symbols": ["void"], "postprocess": id},
    {"name": "factors", "symbols": ["time"], "postprocess": id},
    {"name": "factors", "symbols": ["var_name"], "postprocess": id},
    {"name": "factors", "symbols": ["array"], "postprocess": id},
    {"name": "factors", "symbols": ["bitarray"], "postprocess": id},
    {"name": "factors", "symbols": ["point4"], "postprocess": id},
    {"name": "factors", "symbols": ["point3"], "postprocess": id},
    {"name": "factors", "symbols": ["point2"], "postprocess": id},
    {"name": "factors", "symbols": ["expr_seq"], "postprocess": id},
    {"name": "factors", "symbols": [{"literal":"?"}], "postprocess": d => ({type: 'Keyword', value: d[0]})},
    {"name": "factors", "symbols": [(mxLexer.has("error") ? {type: "error"} : error)], "postprocess": id},
