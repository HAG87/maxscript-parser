...
declare var kw_rcmenu: any;
declare var kw_submenu: any;
declare var kw_separator: any;
declare var kw_menuitem: any;
declare var kw_plugin: any;
declare var kw_parameters: any;
declare var kw_tool: any;
declare var kw_utility: any;
declare var kw_rollout: any;
declare var kw_group: any;
declare var kw_uicontrols: any;
declare var kw_macroscript: any;
declare var kw_struct: any;
declare var kw_scope: any;
declare var kw_on: any;
declare var kw_do: any;
declare var kw_return: any;
declare var kw_when: any;
declare var kw_mapped: any;
declare var kw_function: any;
declare var kw_at: any;
declare var kw_level: any;
declare var kw_time: any;
declare var kw_in: any;
declare var kw_coordsys: any;
declare var kw_local: any;
declare var kw_about: any;
declare var kw_with: any;
declare var kw_context: any;
declare var kw_defaultAction: any;
declare var kw_undo: any;
...
declare var kw_while: any;
declare var kw_collect: any;
declare var kw_exit: any;
declare var kw_if: any;
declare var kw_then: any;
declare var kw_else: any;
declare var kw_try: any;
declare var kw_catch: any;
declare var kw_global: any;
declare var kw_persistent: any;
declare var assign: any;
declare var kw_as: any;
declare var kw_compare: any;
declare var kw_not: any;
declare var comparison: any;
declare var delimiter: any;
declare var error: any;
declare var arraydef: any;
declare var rparen: any;
declare var bitarraydef: any;
declare var rbrace: any;
declare var bitrange: any;
declare var identity: any;
declare var global_typed: any;
declare var typed_iden: any;
declare var kw_objectset: any;
...
declare var statement: any;
declare var newline: any;
declare var ws: any;
declare var comment_BLK: any;
...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "rcmenu_def$ebnf$1", "symbols": [], "postprocess": () => null},
    ...
    {"name": "rcmenu_submenu$ebnf$1", "symbols": [], "postprocess": () => null},
    {"name": "rcmenu_submenu$ebnf$2", "symbols": ["rcmenu_clauses"], "postprocess": id},
    {"name": "rcmenu_submenu$ebnf$2", "symbols": [], "postprocess": () => null},
    ...
    {"name": "rcmenu_sep$ebnf$1", "symbols": [], "postprocess": () => null},
    ...
    {"name": "rcmenu_item$ebnf$1", "symbols": ["rcmenu_item$ebnf$1", "rcmenu_item$ebnf$1$subexpression$1"], "postprocess": (d) => d[0].concat([d[1]])},
    ...
    {"name": "plugin_def$ebnf$1", "symbols": ["plugin_def$ebnf$1", "plugin_def$ebnf$1$subexpression$1"], "postprocess": (d) => d[0].concat([d[1]])},
    ...
    {"name": "plugin_clauses$ebnf$1", "symbols": ["plugin_clauses$ebnf$1", "plugin_clauses$ebnf$1$subexpression$1"], "postprocess": (d) => d[0].concat([d[1]])},
    ...
    {"name": "plugin_parameter$ebnf$1", "symbols": ["plugin_parameter$ebnf$1", "plugin_parameter$ebnf$1$subexpression$1"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "plugin_parameter$ebnf$2", "symbols": ["param_clauses"], "postprocess": id},
    {"name": "plugin_parameter$ebnf$2", "symbols": [], "postprocess": () => null},
    ...
    {"name": "param_defs$ebnf$1", "symbols": ["param_defs$ebnf$1", "param_defs$ebnf$1$subexpression$1"], "postprocess": (d) => d[0].concat([d[1]])},
    ...
    {"name": "tool_def$ebnf$1", "symbols": ["tool_def$ebnf$1", "tool_def$ebnf$1$subexpression$1"], "postprocess": (d) => d[0].concat([d[1]])},
    ...
    {"name": "tool_clauses$ebnf$1", "symbols": ["tool_clauses$ebnf$1", "tool_clauses$ebnf$1$subexpression$1"], "postprocess": (d) => d[0].concat([d[1]])},
    ...
    {"name": "utility_def$ebnf$1", "symbols": ["utility_def$ebnf$1", "utility_def$ebnf$1$subexpression$1"], "postprocess": (d) => d[0].concat([d[1]])},
    ...
    {"name": "utility_clauses$ebnf$1", "symbols": ["utility_clauses$ebnf$1", "utility_clauses$ebnf$1$subexpression$1"], "postprocess": (d) => d[0].concat([d[1]])},
    ...
    {"name": "rollout_def$ebnf$1", "symbols": ["rollout_def$ebnf$1", "rollout_def$ebnf$1$subexpression$1"], "postprocess": (d) => d[0].concat([d[1]])},
    ...
    {"name": "rollout_clauses$ebnf$1", "symbols": ["rollout_clauses$ebnf$1", "rollout_clauses$ebnf$1$subexpression$1"], "postprocess": (d) => d[0].concat([d[1]])},
    ...
    {"name": "rollout_item$ebnf$1", "symbols": [], "postprocess": () => null},
    {"name": "rollout_item$ebnf$2", "symbols": []},
    {"name": "rollout_item$ebnf$2$subexpression$1", "symbols": ["_", "parameter"]},
    {"name": "rollout_item$ebnf$2", "symbols": ["rollout_item$ebnf$2", "rollout_item$ebnf$2$subexpression$1"], "postprocess": (d) => d[0].concat([d[1]])},
    ...
    {"name": "macroscript_def$ebnf$1", "symbols": ["macroscript_def$ebnf$1", "macroscript_def$ebnf$1$subexpression$1"], "postprocess": (d) => d[0].concat([d[1]])},
    ...
    {"name": "macroscript_def$ebnf$2", "symbols": [], "postprocess": () => null},
    ...
    {"name": "macro_script_body$ebnf$1", "symbols": ["macro_script_body$ebnf$1", "macro_script_body$ebnf$1$subexpression$1"], "postprocess": (d) => d[0].concat([d[1]])},
    ...
    {"name": "event_args$ebnf$1", "symbols": ["event_args$ebnf$1", "event_args$ebnf$1$subexpression$2"], "postprocess": (d) => d[0].concat([d[1]])},
    ...
    {"name": "change_handler$ebnf$1", "symbols": [], "postprocess": () => null},
    ...
    {"name": "change_handler$ebnf$2", "symbols": [], "postprocess": () => null},
    ...
    {"name": "change_handler$ebnf$3", "symbols": [], "postprocess": () => null},
    ...
    {"name": "change_handler$ebnf$4", "symbols": [], "postprocess": () => null},
    ...
    {"name": "function_def$ebnf$1", "symbols": ["function_def$ebnf$1", "function_def$ebnf$1$subexpression$2"], "postprocess": (d) => d[0].concat([d[1]])},
    ...
    {"name": "function_def$ebnf$2", "symbols": ["function_def$ebnf$2", "function_def$ebnf$2$subexpression$2"], "postprocess": (d) => d[0].concat([d[1]])},
    ...
    {"name": "function_def$ebnf$3", "symbols": ["function_def$ebnf$3", "function_def$ebnf$3$subexpression$2"], "postprocess": (d) => d[0].concat([d[1]])},
    ...
    {"name": "function_def$ebnf$4", "symbols": ["function_def$ebnf$4", "function_def$ebnf$4$subexpression$2"], "postprocess": (d) => d[0].concat([d[1]])},
    ...
    {"name": "function_decl$ebnf$1", "symbols": [], "postprocess": () => null},
    ...
    {"name": "fn_return$ebnf$1", "symbols": [], "postprocess": () => null},
    ...
    {"name": "context_expr$ebnf$1", "symbols": ["context_expr$ebnf$1", "context_expr$ebnf$1$subexpression$1"], "postprocess": (d) => d[0].concat([d[1]])},
    ...
    {"name": "context$ebnf$2", "symbols": [], "postprocess": () => null},
    ...
    {"name": "context$ebnf$3", "symbols": [], "postprocess": () => null},
    ...
    {"name": "context$ebnf$4", "symbols": [], "postprocess": () => null},
    ...
    {"name": "case_expr$ebnf$1", "symbols": ["case_expr$ebnf$1", "case_expr$ebnf$1$subexpression$1"], "postprocess": (d) => d[0].concat([d[1]])},
    ...
    {"name": "for_loop$ebnf$1", "symbols": [], "postprocess": () => null},
    ...
    {"name": "for_sequence$ebnf$1", "symbols": [], "postprocess": () => null},
    ...
    {"name": "for_sequence$ebnf$2", "symbols": [], "postprocess": () => null},
    ...
    {"name": "for_sequence$ebnf$3", "symbols": [], "postprocess": () => null},
    ...
    {"name": "for_sequence$ebnf$4", "symbols": [], "postprocess": () => null},
    ...
    {"name": "decl_args$ebnf$1", "symbols": ["decl_args$ebnf$1", "decl_args$ebnf$1$subexpression$2"], "postprocess": (d) => d[0].concat([d[1]])},
    ...
    {"name": "fn_call$ebnf$1", "symbols": [], "postprocess": () => null},
    ...
    {"name": "EOL$ebnf$1", "symbols": ["EOL$ebnf$1", "_eol"], "postprocess": (d) => d[0].concat([d[1]])},
